 ...
 */
enum {
    RAWRTC_DCEP_PPID_CONTROL = 50,
    RAWRTC_DCEP_PPID_UTF16 = 51,
    RAWRTC_DCEP_PPID_UTF16_EMPTY = 56,
    RAWRTC_DCEP_PPID_UTF16_PARTIAL = 54, // deprecated
    RAWRTC_DCEP_PPID_BINARY = 53,
    RAWRTC_DCEP_PPID_BINARY_EMPTY = 57,
    RAWRTC_DCEP_PPID_BINARY_PARTIAL = 52 // deprecated
};
